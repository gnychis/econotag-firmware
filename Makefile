...
TARGETS := awmon_firmware rftest-tx-csma rftest-tx-nocsma rftest-rx rftest-rx-autoack rftest-tx-autoack
...
TARGETS_WITH_ROM_VARS := awmon_firmware rftest-tx-csma rftest-tx-nocsma rftest-rx rftest-rx-autoack rftest-tx-autoack
